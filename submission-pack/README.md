...
| `proof/mainnet-readiness.md` | Mainnet deployment status, IDs, and remaining public URL blocker |
| `proof/asset-manifest.md` | All attached assets and where to upload them |
| `assets/screenshots/` | Product screenshots |
| `assets/posters/` | Poster files |
| `assets/docs/` | Architecture and storage PDFs/PNGs |
| `assets/logo/` | Logo and mark assets |
| `video/` | Demo video script/source |

## Submit-Ready Status

- Product screenshots: ready.
- Product screenshots refreshed after the English-only cartoon gallery update and Daily What's Up feature.
- Poster: ready.
...
- Live mainnet project URL after SuiNS is pointed to the Walrus Site object
- X account
- X tweet link with `#Walrus`
- Referrer, if any

Do not submit testnet IDs as final production proof. Use only mainnet IDs and the final SuiNS `wal.app` URL.
